...
public final class Constants {
    ...
    //public static final int SUCCESS_RESULT2 = 0;
    public static final int USE_ADDRESS_NAME = 1;
    public static final int USE_ADDRESS_LOCATION = 2;

    public static final String PACKAGE_NAME =
            "com.example.artisansfinal";
    public static final String RECEIVER = PACKAGE_NAME + ".RECEIVER";
    public static final String RESULT_DATA_KEY = PACKAGE_NAME + ".RESULT_DATA_KEY";
    public static final String RESULT_ADDRESS = PACKAGE_NAME + ".RESULT_ADDRESS";
    //public static final String RESULT_ADDRESS2 = PACKAGE_NAME + ".RESULT_ADDRESS";
    ...
    //public static final String LOCATION_NAME_DATA_EXTRA2 = PACKAGE_NAME + ".LOCATION_NAME_DATA_EXTRA";
